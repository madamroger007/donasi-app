    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                TextInput::make('no_telepon')->required()->maxLength(255)->numeric(),
                TextInput::make('no_whatsapp')->required()->maxLength(255)->numeric(),
                ...
                DateTimePicker::make('tanggal_lahir')
                    ->native(false)
                    ->required(),
                    DateTimePicker::make('tanggal_gabung')
                    ->native(false)
                    ->required(),
                ...
                TextInput::make('kode_pos')->required()->maxLength(255)->label('Kode Pos'),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('kode_pos')->sortable()->searchable(),
